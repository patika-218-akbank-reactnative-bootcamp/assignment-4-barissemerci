...
const EditProfileScreen = props => {
  ...
  const[id,setUserId]=useState(JSON.parse(user)[0].id)
  ...
  return (
    <View style={[styles.container, {backgroundColor: theme.backgroundColor}]}>
      <View style={styles.textInputs}>
        <Text style={[styles.textStyle,{color:theme.fontColor}]}>User Name</Text>
        <TextInput
          value={username}
          onChangeText={usernameNew => setUserName(usernameNew)}
          style={[styles.textInputStyles,{borderColor:theme.fontColor,color:theme.fontColor}]}
        />
        ...
        />
        <Text style={[styles.textStyle,{color:theme.fontColor}]}>Password</Text>
        <TextInput
          value={password}
      ...
      <TouchableOpacity
        ...
        <Text style={[styles.buttonTextStyle,{color:theme.fontColor}]}>Save</Text>
      </TouchableOpacity>
    </View>
  );
};

...
const LoginScreen = props => {
  ...
  useEffect (()  => {
    ...
    function getUsers(){
      ...
      fetch('http://10.0.2.2:3000/users').then(
      async result=>{
...
style={styles.iconMovieStyle}
        ...
        value={username}
          ...
          style={[styles.textInput,{color:theme.fontColor,borderColor:theme.fontColor}]}
        />
      ...
      <View style={[styles.buttonStyle,{borderColor:theme.fontColor}]}>
        <TouchableOpacity onPress={handleLogin}>
          <Text style={[styles.buttonTextStyle,{color:theme.fontColor}]}>Log in</Text>
        </TouchableOpacity>
      </View>
      <TouchableOpacity onPress={navigateSignupScreen}>
        <Text style={[styles.signUpTextStyle,{color:theme.active}]}>New to ...?  SIGN UP</Text>
      </TouchableOpacity>
    </View>
